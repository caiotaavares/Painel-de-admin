<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2"></h1>
			...
			<div class="col-md-12">
                    <!-- Se existir a variável que armazena os dados de um jogo
                    apenas, o método utilizado será o com a função de editar
                    um jogo, se não o método chamado será o de cadastrar -->
				<?php if(isset($game)) : ?>
                    <!-- url que aponta para o endereço de um jogo pelo id -->
					<form action="<?= base_url() ?>games/update/ <?= $game["id"] ?> " method="post">
                <?php else : ?>
                    <!-- url que aponta para o cadastro de um novo jogo -->
